# LangChain による Agentic AI 開発実践 — 演習コードリポジトリ

このリポジトリは、研修コース **「LangChain による Agentic AI 開発実践」** (2 日間) のハンズオン・演習用コード一式です。各章のフォルダ (`chap01`〜`chap08`) に、講師と一緒に動かす **ハンズオン** と、自分で完成させる **演習** が入っています。
